...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows($result)>0){
		...
		$body= 'Hello '.$row['name'].' you have requested for your password, your password is <b>'.$row['password'].'</b>';
		if(sendEmail($row['email'],$row['name'],$subject,$body)){
			echo '<script>swal("Successfully", "Please check your email", "success").then(function() { window.location = "index.php";  });</script>';
		}
		else{
