...
if($row['status']==0)
{
	...
	echo '<form method="post">
			...
			<button type="submit" name="status" value="1" class="btn btn-info btn-sm">Approve</button>
			<button type="submit" name="status" value="-1" class="btn btn-danger mt-2 btn-sm">Reject</button>
	</form>';	
}
...
?></td>
<td>
<a href="vacancies_detail.php?id=<?php echo $row['id'];?>"><button class="btn btn-warning btn-sm">View Detail</button></a>
